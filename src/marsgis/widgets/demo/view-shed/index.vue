<template>
  <mars-dialog :visible="true" right="10" top="50" v-bind="attrs">
    <graphic-layer-state
      :defaultCount="10"
      :interaction="false"
  ...
  >
    ...
    <div class="f-mb">
      <a-space>
        ...
        <mars-slider @change="onChangeAngle2" v-model:value="video.cameraAngle2" :min="10" :max="45" :step="0.1" />
      </a-space>
    </div>
    ...
    <div class="f-mb">
      <a-space>
        ...
        <mars-slider @change="onChangeaddHeight" v-model:value="video.addHeightValue" :min="0" :max="180" :step="0.1" />
      </a-space>
    </div>
    <div class="f-mb">
      <a-space>
...
import GraphicLayerState from "./mars-sample/index.vue"
...
function onchoose(data) {
  console.log("xx", data)
  mapWork.start3DrawGraphic(data)
}
...
const onChangeaddHeight = () => {
  mapWork.onChangeaddHeight(video.addHeightValue)
}
