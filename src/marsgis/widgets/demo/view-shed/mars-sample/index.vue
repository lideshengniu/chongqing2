<template>
  ...
  <div class="f-mb">
    <a-space>
      <span class="mars-pannel-item-label">方案选择:</span>
      <mars-select :options="modelOptions" @change="onchoose"></mars-select>
    </a-space>
  </div>
  <div class="f-mb">
    <a-space>
...
const modelOptions = [
  {
    value: "fangan1",
    label: "方案1",
    style: { angle1: 15, angle2: 15 }
  },
  {
    value: "fangan2",
    label: "方案2",
    style: { angle1: 30, angle2: 30 }
  },
  {
    value: "fangan3",
    label: "方案3",
    style: { angle1: 60, angle2: 45 }
  }
]
...
onMounted(() => {
  ...
  graphicLayer.on(mars3d.EventType.addGraphic, function (event) {
    ...
    console.log(graphic.type, "tyoeeee")
    if (graphic.type === "viewShed") {
...
const emit = defineEmits(["onStartEditor", "onStopEditor", "choose"])
